...
namespace gps {
    ...
    void SkyBox::Draw(GLuint shader, glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
    {
        
        //set the view and projection matrices
        glm::mat4 transformedView = glm::mat4(glm::mat3(viewMatrix));
        glUniformMatrix4fv(glGetUniformLocation(shader, "view"), 1, GL_FALSE, glm::value_ptr(transformedView));
